...
Version 0.11.0 includes the private personal library, reliable Google OAuth, translated-title book search, provider and custom covers, reading sessions, readable calendar cards, streaks, book completion, yearly goals, user-owned ordered series, physical seasonal shelves with spine-first books and themed page artwork, reading-language history, real monthly/yearly recaps, account export and protected account deletion.
